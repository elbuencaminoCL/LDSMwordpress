                    ...
                    ?>
                    	<div class="col-sm-4 col-xs-12 caluga-galeria">
							<div class="block contenedor-album">
								...
								<?
									$excerpt= apply_filters('the_excerpt', get_post_field('post_excerpt', $gal->ID));
									if($excerpt) {
                                        echo '<h4 class="desc-galeria upper">'.$excerpt.'</h4>';
                                    } else {
                                        echo '<h4 class="desc-galeria upper">'.content(5).'</h4>';
                                    }
								?>
